 ...
 * years に 1 未満（例: 0.5）を入れると「1 年未満」と表示される。level は 6 段階で、経験年数から「level = 年数 + 1（上限 6、1 年未満は 1）」の規則で割り振る。
 */
export const skillCategories: SkillCategory[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'AWS (EC2 / Route 53)', level: 1, years: 0.5 },
    ],
  },
];
